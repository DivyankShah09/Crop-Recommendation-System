...
<ul>
    ...
    <li align="justify">One of the most crucial elements of precision and automated agriculture is crop suggestion. Numerous variables are taken into account while recommending crops.</li>
    <li>Farmers often don't know which crops to grow.</li>
    <li align="justify">In this project, we aim to build such a website in which farmers will giveninput on the soil composition of the field and the climatic condition of the area. Based on several parameters, the website will suggest which crop will be most suitable according to the given inputs by the farmer with the help of artificial neural network.</li>
</ul>
